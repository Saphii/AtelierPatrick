...
const DecorativeMarble = styled.div`
  ...
  margin: 20px; /* Marge pour éviter de toucher les divs */
...
const Home = () => {
  ...
  return (
    <HomeContainer>
      {/* Billes décoratives en fond d'écran - Réparties aléatoirement dans l'espace blanc */}
      {/* Logo Bois (3D) */}
      <DecorativeMarble left="3%" top="120px" size="65px" delay="0s" duration="9s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.7), rgba(160, 82, 45, 0.7))">
      ...
      {/* Logo Atelier de Patrick */}
      <DecorativeMarble right="5%" top="150px" size="60px" delay="1s" duration="11s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.68), rgba(160, 82, 45, 0.68))">
        <img src="/images/logo_patrick.png" alt="Logo Atelier de Patrick" />
      </DecorativeMarble>

      {/* Logo 3D */}
      <DecorativeMarble left="8%" top="280px" size="55px" delay="2s" duration="10s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.65), rgba(160, 82, 45, 0.65))">
      ...
      {/* Logo Bois (3D) */}
      <DecorativeMarble right="12%" top="350px" size="58px" delay="3.5s" duration="8.5s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.7), rgba(160, 82, 45, 0.7))">
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 36 36">
          <path fill="#662113" d="M17.34 1.835C11.231 2.323 9 5.399 9 8.34c0 2.101-.348 17.904-.348 20.005s2.071 4.385 4.946 5.703c4.186 1.919 14.663 1.074 14.569-5.926c-.107-7.999.045-18.757.045-18.757c-.001-5.213-4.845-8.012-10.872-7.53z"/>
          <path fill="#C1694F" d="M10.948 10.993c3.768 3.14 9.956 2.961 13.601 1.026c3.5-1.858 3.796-4.882 1.488-7.288C24.07 2.68 19.365 1.6 15.311 2.524c-4.561 1.04-8.058 5.389-4.363 8.469z"/>
          <path fill="#FFE8B6" d="M11.949 10.568c3.271 2.726 8.37 2.407 11.807.891c3.147-1.389 3.52-4.01 1.292-6.327c-1.71-1.778-5.792-2.718-9.312-1.916c-3.959.902-6.995 4.678-3.787 7.352z"/>
      ...
      {/* Logo Atelier de Patrick - Milieu gauche */}
      <DecorativeMarble left="14%" bottom="280px" size="52px" delay="4s" duration="9.5s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.65), rgba(160, 82, 45, 0.65))">
        <img src="/images/logo_patrick.png" alt="Logo Atelier de Patrick" />
      </DecorativeMarble>

      {/* Logo 3D - Milieu droite */}
      <DecorativeMarble right="14%" bottom="320px" size="50px" delay="1.5s" duration="10.5s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.62), rgba(160, 82, 45, 0.62))">
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path fill="currentColor" d="M13 15h3q.825 0 1.413-.587T18 13v-2q0-.825-.587-1.412T16 9h-3zm1.5-1.5v-3H16q.2 0 .35.15t.15.35v2q0 .2-.15.35t-.35.15zm-8 1.5H10q.425 0 .713-.288T11 14v-1q0-.425-.288-.712T10 12q.425 0 .713-.288T11 11v-1q0-.425-.288-.712T10 9H6.5v1.5h3v.75h-2v1.5h2v.75h-3zM4 20q-.825 0-1.412-.587T2 18V6q0-.825.588-1.412T4 4h16q.825 0 1.413.588T22 6v12q0 .825-.587 1.413T20 20z"/>
        </svg>
      </DecorativeMarble>

      {/* Logo Bois (3D) - Milieu gauche */}
      <DecorativeMarble left="18%" bottom="240px" size="48px" delay="5s" duration="8s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.62), rgba(160, 82, 45, 0.62))">
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 36 36">
          <path fill="#662113" d="M17.34 1.835C11.231 2.323 9 5.399 9 8.34c0 2.101-.348 17.904-.348 20.005s2.071 4.385 4.946 5.703c4.186 1.919 14.663 1.074 14.569-5.926c-.107-7.999.045-18.757.045-18.757c-.001-5.213-4.845-8.012-10.872-7.53z"/>
          <path fill="#C1694F" d="M10.948 10.993c3.768 3.14 9.956 2.961 13.601 1.026c3.5-1.858 3.796-4.882 1.488-7.288C24.07 2.68 19.365 1.6 15.311 2.524c-4.561 1.04-8.058 5.389-4.363 8.469z"/>
          <path fill="#FFE8B6" d="M11.949 10.568c3.271 2.726 8.37 2.407 11.807.891c3.147-1.389 3.52-4.01 1.292-6.327c-1.71-1.778-5.792-2.718-9.312-1.916c-3.959.902-6.995 4.678-3.787 7.352z"/>
      ...
      {/* Logo Atelier de Patrick */}
      <DecorativeMarble right="4%" bottom="180px" size="55px" delay="2.5s" duration="9s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.68), rgba(160, 82, 45, 0.68))">
        <img src="/images/logo_patrick.png" alt="Logo Atelier de Patrick" />
      </DecorativeMarble>

      {/* Billes supplémentaires en bas à gauche et bas à droite */}
      {/* Bas gauche - Logo Bois */}
      <DecorativeMarble left="2%" bottom="120px" size="56px" delay="3s" duration="10s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.7), rgba(160, 82, 45, 0.7))">
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 36 36">
          <path fill="#662113" d="M17.34 1.835C11.231 2.323 9 5.399 9 8.34c0 2.101-.348 17.904-.348 20.005s2.071 4.385 4.946 5.703c4.186 1.919 14.663 1.074 14.569-5.926c-.107-7.999.045-18.757.045-18.757c-.001-5.213-4.845-8.012-10.872-7.53z"/>
          <path fill="#C1694F" d="M10.948 10.993c3.768 3.14 9.956 2.961 13.601 1.026c3.5-1.858 3.796-4.882 1.488-7.288C24.07 2.68 19.365 1.6 15.311 2.524c-4.561 1.04-8.058 5.389-4.363 8.469z"/>
          <path fill="#FFE8B6" d="M11.949 10.568c3.271 2.726 8.37 2.407 11.807.891c3.147-1.389 3.52-4.01 1.292-6.327c-1.71-1.778-5.792-2.718-9.312-1.916c-3.959.902-6.995 4.678-3.787 7.352z"/>
      ...
      {/* Bas gauche - Logo 3D */}
      <DecorativeMarble left="5%" bottom="80px" size="54px" delay="4.5s" duration="9.5s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.65), rgba(160, 82, 45, 0.65))">
        <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path fill="currentColor" d="M13 15h3q.825 0 1.413-.587T18 13v-2q0-.825-.587-1.412T16 9h-3zm1.5-1.5v-3H16q.2 0 .35.15t.15.35v2q0 .2-.15.35t-.35.15zm-8 1.5H10q.425 0 .713-.288T11 14v-1q0-.425-.288-.712T10 12q.425 0 .713-.288T11 11v-1q0-.425-.288-.712T10 9H6.5v1.5h3v.75h-2v1.5h2v.75h-3zM4 20q-.825 0-1.412-.587T2 18V6q0-.825.588-1.412T4 4h16q.825 0 1.413.588T22 6v12q0 .825-.587 1.413T20 20z"/>
        </svg>
      </DecorativeMarble>

      {/* Bas droite - Logo Atelier de Patrick */}
      <DecorativeMarble right="2%" bottom="120px" size="57px" delay="5.5s" duration="8.5s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.68), rgba(160, 82, 45, 0.68))">
        <img src="/images/logo_patrick.png" alt="Logo Atelier de Patrick" />
      </DecorativeMarble>

      {/* Bas droite - Logo Bois */}
      <DecorativeMarble right="6%" bottom="80px" size="53px" delay="6s" duration="10s" gradient="linear-gradient(135deg, rgba(139, 69, 19, 0.7), rgba(160, 82, 45, 0.7))">
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 36 36">
          <path fill="#662113" d="M17.34 1.835C11.231 2.323 9 5.399 9 8.34c0 2.101-.348 17.904-.348 20.005s2.071 4.385 4.946 5.703c4.186 1.919 14.663 1.074 14.569-5.926c-.107-7.999.045-18.757.045-18.757c-.001-5.213-4.845-8.012-10.872-7.53z"/>
          <path fill="#C1694F" d="M10.948 10.993c3.768 3.14 9.956 2.961 13.601 1.026c3.5-1.858 3.796-4.882 1.488-7.288C24.07 2.68 19.365 1.6 15.311 2.524c-4.561 1.04-8.058 5.389-4.363 8.469z"/>
          <path fill="#FFE8B6" d="M11.949 10.568c3.271 2.726 8.37 2.407 11.807.891c3.147-1.389 3.52-4.01 1.292-6.327c-1.71-1.778-5.792-2.718-9.312-1.916c-3.959.902-6.995 4.678-3.787 7.352z"/>
